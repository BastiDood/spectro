...
<button
  class="btn fixed left-0 mt-10 rounded-l-sm px-1 btn-accent md:hidden"
...
<div class="grid grid-cols-[auto_1fr]">
  ...
  >
    <ul
      class="menu flex-nowrap menu-lg bg-base-300 px-6 py-4 md:sticky md:top-32 md:menu-md md:rounded-box"
    >
