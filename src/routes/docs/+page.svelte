...
<div class="prose max-w-full p-10 prose-headings:scroll-mt-10 prose-h2:border-b prose-h2:border-neutral prose-h2:pb-3">
    ...
    <code class="rounded-md bg-base-300 px-4 py-2 text-lg text-primary drop-shadow-md"
        >/help <span class="badge badge-neutral tooltip tooltip-accent" data-tip="Message visibility: public (optional)"
            >preview</span
        ></code
    >
    <p class="mb-10">
    ...
    <code class="rounded-md bg-base-300 px-4 py-2 text-lg text-primary drop-shadow-md"
        >/info <span class="badge badge-neutral tooltip tooltip-accent" data-tip="Message visibility: public (optional)"
            >preview</span
        ></code
    >
    <p class="mb-10">
    ...
    <div>
        <code id="confess" class="scroll-mt-10 rounded-md bg-base-300 px-3 py-1.5 text-lg text-primary drop-shadow-md"
            >/confess <span
                ...
                data-tip="Content of the confession message">content</span
            ></code
        >
        <span class="badge badge-info badge-outline ml-2">Required permissions: Send Messages</span>
    </div>
    <p class="mb-10">
    ...
    <div>
        <code class="rounded-md bg-base-300 px-3 py-1.5 text-lg text-primary drop-shadow-md"
            ...
            <span
                class="badge badge-secondary tooltip tooltip-accent"
                data-tip="Moderator-only channel for confession logs">channel</span
            >
            <span
                class="badge badge-neutral tooltip tooltip-accent"
                data-tip="Custom title for confession messages (optional)">label</span
            >
            <span
                class="badge badge-neutral tooltip tooltip-accent"
                data-tip="Custom hex color for confession messages (optional)">color</span
            >
            <span
                class="badge badge-neutral tooltip tooltip-accent"
                data-tip="Require approvals: true or false (default)">approval</span
            >
        </code>
        <span class="badge badge-info badge-outline ml-2">Required permissions: Manage Channels</span>
    </div>
    <p>
    ...
    <div>
        <code class="rounded-md bg-base-300 px-3 py-1.5 text-lg text-primary drop-shadow-md"
            >/resend <span class="badge badge-secondary tooltip tooltip-accent" data-tip="ID of confession to resend"
                >id</span
            ></code
        >
        <span class="badge badge-info badge-outline ml-2">Required permissions: Manage Messages</span>
    </div>
    <p class="mb-10">
