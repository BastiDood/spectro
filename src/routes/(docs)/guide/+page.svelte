...
<section>
  ...
  <ul>
    <li>
      ...
      <ul>
        <li>
          Optionally, the <span class="badge badge-accent">Attach Files</span> permission is required
          for sending attachments with the confession.
        </li>
      </ul>
    </li>
    <li>
...
<section>
  ...
  <p>
    ...
    To send an attachment along with the confession, the
