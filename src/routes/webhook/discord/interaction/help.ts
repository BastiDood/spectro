    ...
    embeds: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            value:
              'Requires the **"Send Messages"** permission and the **"Attach Files"** permission (only when sending an `attachment`). Send a confession to a channel. This command fails if the current channel has not yet been configured to receive confessions.',
          },
          {
